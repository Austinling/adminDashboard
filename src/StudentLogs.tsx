              ...
              <>
                <div className="p-3 flex flex-col items-center">
                  ...
                  <div className="flex flex-col">
                    <div>Name: {detailsIntoJSON.name}</div>
                    <div>Phone Number: {detailsIntoJSON.phoneNumber}</div>
                    <div>Grade: {detailsIntoJSON.grade}</div>
                    <div>Time Period: {detailsIntoJSON.timePeriod}</div>
                    <div>Class Date: {detailsIntoJSON.classDate}</div>
                  </div>
                </div>
              </>
            );
